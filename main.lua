...
local UniversalSection5 = UniversalTab:NewSection("Settings")
local UniversalSection6 = UniversalTab:NewSection("Credits : Efe Tahça")
...
UniversalSection5:NewKeybind("Hide (Default P)", "Hide", Enum.KeyCode.P, function()
	Library:ToggleUI()
end)
